...
//
//     final _init = nativeApiLib.lookup<
//         NativeFunction<Pointer<Utf8> Function()>>('init');
//     _initialize = _init.asFunction<Pointer<Utf8> Function()>();
//
//     return true;
//   }
//
...
void main() {
  ...
  LibFptr lib = LibFptr(DynamicLibrary.open('libfptr10.so'));
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            // Column(children: [
            //   Text('capitalize flutter=${FFIBridge.capitalize('jmlabs')}',
            //       style: TextStyle(fontSize: 40)),
            //   Text('1+2=${FFIBridge.add(1488, 1488)}', style: TextStyle(fontSize: 40)),
            //   Text('Driver version: ${FFIBridge.i()}', style: TextStyle(fontSize: 40)),
            // ],),
            const Text(
